...
def handle(client):
    ...
    Note: This will not give to an error when client is not sending something, but give you error when he/she is unable to send
    '''
    while True:
        try:
